...
class TikTokVoice(Enum):
    """
    Class ripped from https://github.com/mark-rez/TikTok-Voice-TTS/blob/main/tiktok_voice/src/voice.py
    """
    ...
    # OTHER
    MALE_STORYTELLER = 'en_male_narration'
